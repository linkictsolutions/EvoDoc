...
const WAY_BILL_TEMPLATE_STORAGE_KEY = "evodoc.templates.way_bill.v5";
...
function billOfLadingRiderPages(output: DocumentOutputSnapshot): ReactNode[] {
      ...
      <table className="print-table bl-table bl-rider-table">
        ...
        <tbody>
          ...
          <tr className="bl-rider-footer-row">
            <td><span className="bl-label-lite">PLACE AND DATE OF ISSUE</span><br /><span className="bl-field-value bl-field-value-spaced">{display(page["Place and Date of Issue"])}</span></td>
            ...
            <td colSpan={3}><span className="bl-label-lite">SIGNED on behalf of the Carrier MSC Mediterranean Shipping Company S.A.</span></td>
          </tr>
        </tbody>
      </table>
    </article>
...
function billOfLadingPrintPages({ output }: Props): ReactNode[] {
  ...
  return [
    <article key="bl-main-page" className="print-sheet bl-sheet">
