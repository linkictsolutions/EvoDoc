...
export function buildBillOfLadingSample(args: {
  ...
  return {
    ...
    footer: {
      ...
      legalText:
        "RECEIVED by the Carrier in apparent good order and condition (unless otherwise stated herein) the total number or quantity of Containers or other packages or units indicated in the box entitled Carrier’s Receipt for carriage subject to all the terms and conditions hereof.",
